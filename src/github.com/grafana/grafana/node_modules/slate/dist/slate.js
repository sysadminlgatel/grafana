  ...
  createClass(Text, [{
    ...
    value: function getActiveMarksBetweenOffsets(startOffset, endOffset) {
      ...
      return result.withMutations(function (x) {
        for (var index$$1 = startOffset + 1; index$$1 < endOffset; index$$1++) {
          var c = _this2.characters.get(index$$1);
          x.intersect(c.marks);
          if (x.size === 0) return;
        }
      });
    ...
    value: function getMarksBetweenOffsets(startOffset, endOffset) {
      ...
      return new immutable.OrderedSet().withMutations(function (result) {
        for (var index$$1 = startOffset; index$$1 < endOffset; index$$1++) {
          var c = _this4.characters.get(index$$1);
...
memoize$2(Text.prototype, ['getDecoratedCharacters', 'getDecorations', 'getLeaves', 'getActiveMarks', 'getMarks', 'getMarksAsArray', 'getMarksAtIndex', 'validate']);
