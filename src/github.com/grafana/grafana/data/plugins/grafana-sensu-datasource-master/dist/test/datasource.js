...
exports.SensuDatasource = undefined;
...
var SensuDatasource = exports.SensuDatasource = function () {
  ...
  _createClass(SensuDatasource, [{
    ...
    value: function multipleDataQueries(pendingQueries) {
      ...
      _angular2.default.forEach(pendingQueries, function (aTarget) {
      ...
      this.q.all(dataCalls).then(function (results) {
        ...
        _angular2.default.forEach(results, function (result) {
          _angular2.default.forEach(result.data, function (dataSet) {
