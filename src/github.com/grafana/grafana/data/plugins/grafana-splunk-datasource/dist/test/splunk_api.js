...
exports.splunkAPIFactory = splunkAPIFactory;
...
function splunkAPIFactory($httpParamSerializerJQLike, backendSrv) {
  var SplunkAPI = function () {
    function SplunkAPI(instanceSettings) {
      ...
      this.AUTO_CANCEL = _lodash2.default.isNumber(options.autoCancel) ? options.autoCancel : 30;
      this.STATUS_BUCKETS = _lodash2.default.isNumber(options.statusBuckets) ? options.statusBuckets : 300;
...
var GENERATING_COMMAND_PATTERN = /^\s*\|/;
...
_angular2.default.module('grafana.services').factory('SplunkAPI', splunkAPIFactory);
