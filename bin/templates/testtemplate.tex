...
\fancyhead[R]{}
\fancyhead[L]{\includegraphics[width=2cm]{/opt/testingrepo/public/img/logo.png}}
\fancyfoot[L]{\footnotesize Confidential | Powered by LGA NetDefense\textregistered}
